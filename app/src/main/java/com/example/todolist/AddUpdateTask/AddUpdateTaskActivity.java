...
public class AddUpdateTaskActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intent = getIntent();
            ...
            AddUpdateTaskViewModelFactory factory = new AddUpdateTaskViewModelFactory(getApplication(), mTaskId);
            viewModel = ViewModelProviders.of(this, factory).get(AddUpdateTaskViewModel.class);


        mEditText = findViewById( R.id.editTextCoffee);
    ...
    private void initViews() {
        mEditText = findViewById(R.id.editTextCoffee);
        AddNote=findViewById(R.id.editTextInstruction);
