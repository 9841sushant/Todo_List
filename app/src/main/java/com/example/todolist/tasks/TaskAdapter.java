...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskViewHolder> implements Filterable {
    ...
    */
    private int getPriorityColor(int priority) {
        ...
        switch (priority) {
            case 1:
                priorityColor = ContextCompat.getColor(mContext, R.color.priority1);
                break;
            case 2:
                priorityColor = ContextCompat.getColor(mContext, R.color.priority2);
                break;
            case 3:
                priorityColor = ContextCompat.getColor(mContext, R.color.priority3);
                break;
            default:
                break;
        }
    ...
    class TaskViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public TaskViewHolder(View itemView) {
            ...
            taskDescriptionView = itemView.findViewById(R.id.taskCoffee);
            noteView=itemView.findViewById(R.id.Instruction);
